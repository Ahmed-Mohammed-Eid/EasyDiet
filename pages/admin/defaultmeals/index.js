...
import {onInputChange, clearAll, onCheck} from '@/redux/slices/Admin/defaultmeals_slice';
// LANGUAGE
...
const DefaultMeals = ({role}) => {
    ...
    const {meals: selectedMeals, selectedDay,  checks: {All, Breakfast, Lunch, Dinner, Snacks}, activeTye} = useSelector(state => state.defaultmeals)
    ...
    const submitHandler = async () => {
        ...
        // SET DYNAMIC URL BASED ON THE ROLE
        let url = `https://api.easydietkw.com/api/v1/add/chiff/menu/day`;
        if (role === 'manager') {
            url = `https://api.easydietkw.com/api/v1/manager/add/chiff/menu/day`;
        }
    ...
    const deleteDateHandler = () => {
        ...
        // SET DYNAMIC URL BASED ON THE ROLE
        let url = `https://api.easydietkw.com/api/v1/delete/chiff/menu/day`;
        if (role === 'manager') {
            url = `https://api.easydietkw.com/api/v1/manager/delete/chiff/menu/day`;
        }
            ...
            <main className={classes.Main}>
                <div className={classes.Container}>
                    <div className={classes.Top}>
                        ...
                        <button onClick={() => {
                            router.push('/admin/defaultmeals/days')
                        }}>
